...
return <>
  <div class="bg-indigo-300 p-8">
    <h1 class="text-6xl font-bold">Handle Complex Input</h1>
  </div>
  ...
  <div class="mt-4 px-8 text-gray-800">
    ...
    <div>
      ...
      <div class="bg-indigo-300 rounded-lg py-8 px-4 flex mt-4">
        <input
          onChange={handleChange}
          placeholder={`complex_input.${context.accountId}`}
        />
  ...
  <div class="bg-indigo-300 h-1"></div>
</>
